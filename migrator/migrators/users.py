...
async def migrate(id_maps, migration_stats):
    ...
    #   old_user.first_name
    #   old_user.last_name
    #   old_user.municipality_of_birth
    #   old_user.province_of_birth
    #   old_user.country_of_birth
    #   old_user.nationality
    #   old_user.dc
    #   old_user.census_last_modification_at
    #   old_user.district
    #   old_user.section
    #   old_user.sheet_number
    #   old_user.census_created_at
    #   old_user.collective_entity
    #   old_user.singular_entity
    #   old_user.core
    #   old_user.single_entity_code
    #   old_user.census_phone
    #   old_user.level_of_training
    #   old_user.permit_expiration_at
    #   old_user.province
    #   old_user.municipality
    #   old_user.acronym
    #   old_user.type_road
    #   old_user.street_name
    #   old_user.access
    #   old_user.km
    #   old_user.stairs
    #   old_user.floor
    #   old_user.door
    #   old_user.zip_code
    #   old_user.full_address
    #   old_user.protected_hab
    #   old_user.activo
