...
CREATE TABLE public.tags (
    ...
    "legislation/proposals_count" integer DEFAULT 0,
    "legislation/processes_count" integer DEFAULT 0,
    featured boolean DEFAULT false
);
"""


class OldTaggings(Model):
    class Meta:
        table = "taggings"
        app = "old"
    ...
    taggable_type = fields.CharField(max_length=255)
    # t.integer  "tagger_id"
    tagger_id = fields.IntField(null=True)
    # t.string   "tagger_type"
    tagger_type = fields.CharField(max_length=255)
    # t.string   "context",       limit: 128
    context = fields.CharField(max_length=128)
