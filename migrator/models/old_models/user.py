...
class OldUser(Model):
    ...
    redeemable_code = fields.CharField(max_length=255, null=True)
    ...
    email_on_proposal_notification = fields.BooleanField(default=True)
    ...
    # t.boolean  "activo"
    activo = fields.BooleanField(null=True)
    # t.integer  "district_wide_spending_proposals_supported_count", default: 0
    district_wide_spending_proposals_supported_count = fields.IntField(default=0)
    # t.integer  "city_wide_spending_proposals_supported_count", default: 0
    city_wide_spending_proposals_supported_count = fields.IntField(default=0)
    # t.integer  "supported_spending_proposals_geozone_id"
    supported_spending_proposals_geozone_id = fields.IntField(null=True)
    # t.string "dni_presencial"
    dni_presencial = fields.CharField(max_length=255, null=True)
    # t.string "auth_token"
    auth_token = fields.CharField(max_length=255, null=True)
    # t.integer  "security_question_id"
    security_question_id = fields.IntField(null=True)
    # t.string "security_question_answer"
    security_question_answer = fields.CharField(max_length=255, null=True)
    # t.datetime "verification_confirmed_at"
    verification_confirmed_at = NaiveDatetimeField(null=True)
...
CREATE TABLE public.users (
    ...
    activo boolean,
    district_wide_spending_proposals_supported_count integer DEFAULT 0,
    city_wide_spending_proposals_supported_count integer DEFAULT 0,
    supported_spending_proposals_geozone_id integer,
    dni_presencial character varying,
    auth_token character varying,
    security_question_id integer,
    security_question_answer character varying,
    verification_confirmed_at timestamp without time zone
);
"""
