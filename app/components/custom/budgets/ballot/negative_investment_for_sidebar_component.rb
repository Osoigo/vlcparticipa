class Budgets::Ballot::NegativeInvestmentForSidebarComponent < Budgets::Ballot::InvestmentComponent
  ...
  private
    ...
    def delete_path
      budget_ballot_negativeline_path(budget, id: investment.id, investments_ids: investment_ids)
    end
end
